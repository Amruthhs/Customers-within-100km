import unittest
from customer_records_great_circle import CustomerRecords
from readfile_input import read_file
...
class TestCustomerRecords(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        test = CustomerRecords('Customer_list.txt', 100000, 53.339428, -6.257664)
        self.assertEqual(len(CustomerRecords.get_closest_customers(test)), 16)
